namespace QUQU
{
    partial class Quiz
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox1.Text = "Ты выбрал найти себе союзника для побега. Ящеры предложили свою помощь,\r\nно чтобы" +
    " они помогли, надо отгадать их загадку.\r\nЗагадка: Всех кормит, а сама есть не пр" +
    "осит.";
